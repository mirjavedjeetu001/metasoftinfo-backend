...
let TestimonialsController = class TestimonialsController {
    ...
    create(dto, req) {
        if (req.user.role !== 'SUPER_ADMIN')
            throw new common_1.ForbiddenException('Only super admins can create');
        return this.testimonialsService.create(dto);
    }
    update(id, dto, req) {
        if (req.user.role !== 'SUPER_ADMIN')
            throw new common_1.ForbiddenException('Only super admins can update');
        return this.testimonialsService.update(id, dto);
    }
    remove(id, req) {
        if (req.user.role !== 'SUPER_ADMIN')
            throw new common_1.ForbiddenException('Only super admins can delete');
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, update_testimonial_dto_1.UpdateTestimonialDto, Object]),
    __metadata("design:returntype", void 0)
